...
use UsuariosBundle\Form\ConfiguracionType;
use UsuariosBundle\Entity\Configuracion;
...
class DefaultController extends Controller
{
    ...
    {
        return $this->render('UsuariosBundle:Default:indexparametros.html.twig');
    }
    ...
    /**
     * @Route("/params", name="configuracion_registration")
     */
    public function paramsAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            // ... do any other work - like sending them an email, etc
            // maybe set a "flash" success message for the user
            return new Response("Parametros guardados");
        }
        return $this->render(
            'UsuariosBundle:Default:params.html.twig',
            array('form' => $form->createView())
        );
